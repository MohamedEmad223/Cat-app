...
import 'package:pet_finder_app/feature/home/data/repo/filter_repo.dart';
...
_setupDependencies() {
  ...
  getIt.registerSingleton<HomeRepo>(HomeRepo(homeService: getIt()));
   getIt.registerFactory<HomeCubit>(() => HomeCubit(getIt()));
  //filter
  getIt.registerSingleton<FilterService>(FilterService(getIt()));
  getIt.registerSingleton<FilterRepo>(FilterRepo(getIt()));
  getIt.registerFactory<FilteredCubit>(() => FilteredCubit(getIt()));
}
